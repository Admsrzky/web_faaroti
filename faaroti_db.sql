...
INSERT INTO `cache` (`key`, `value`, `expiration`) VALUES
	...
	('66c67220b06bae60b35bf4e131419342', 'i:3;', 1753814752),
	('66c67220b06bae60b35bf4e131419342:timer', 'i:1753814752;', 1753814752),
	...
	('livewire-rate-limiter:a17961fa74e9275d529f489537f179c05d50c2f3', 'i:1;', 1753676418),
	('livewire-rate-limiter:a17961fa74e9275d529f489537f179c05d50c2f3:timer', 'i:1753676418;', 1753676418);
...
-- Dumping data for table faaroti_db.migrations: ~9 rows (approximately)
...
-- Dumping data for table faaroti_db.products: ~8 rows (approximately)
INSERT INTO `products` (`id`, `nama_produk`, `deskripsi`, `foto_produk`, `harga`, `stok`, `is_popular`, `category_id`, `deleted_at`, `created_at`, `updated_at`) VALUES
	...
	(11, 'Bolu Maniss Lumer', 'Enakkk bangettt', 'products/01K02JX21ZA7FJPJ6GCMV05Q4C.jpg', 20000, 10, 0, 2, NULL, '2025-07-13 12:06:32', '2025-07-29 11:46:52');
...
-- Dumping data for table faaroti_db.sessions: ~7 rows (approximately)
INSERT INTO `sessions` (`id`, `user_id`, `ip_address`, `user_agent`, `payload`, `last_activity`) VALUES
	('3hPPbZMTGEy8pnMXO9btlwrKodHzkdd5hLI0TIel', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/138.0.0.0 Safari/537.36', 'YTozOntzOjY6Il90b2tlbiI7czo0MDoidEVuMTZZUWM4TWcxRzhMQW02ZlhweE1hZ0hRdzhHQ3JrQVdkWmg0QyI7czo5OiJfcHJldmlvdXMiO2E6MTp7czozOiJ1cmwiO3M6MzI6Imh0dHA6Ly8xMjcuMC4wLjE6ODAwMC9wcm9kdWN0cy80Ijt9czo2OiJfZmxhc2giO2E6Mjp7czozOiJvbGQiO2E6MDp7fXM6MzoibmV3IjthOjA6e319fQ==', 1753676882),
	('8VQ71IvKgNemagwTwK2KCfCNc3470lwXtnwGLeLP', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/138.0.0.0 Safari/537.36', 'YToyOntzOjY6Il90b2tlbiI7czo0MDoiTTZBVE9pa1BaQjZ0NUV1RlIzTTZlTkh1b21oa1Zqa2J0dFp6aEN3SCI7czo2OiJfZmxhc2giO2E6Mjp7czozOiJvbGQiO2E6MDp7fXM6MzoibmV3IjthOjA6e319fQ==', 1753814649),
	...
	('qKQ3u0oisAHdTdDGbrA1WRM8hxG74W9xXGaKxcku', 3, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/138.0.0.0 Safari/537.36', '', 1753815333),
	...
	('YcVvwrU6EZk2633G4ecx021hwyFVGhoNNr23iiwv', 2, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/138.0.0.0 Safari/537.36', '', 1753676829);
...
INSERT INTO `transactions` (`id`, `trx_id`, `name`, `email`, `phone`, `city`, `post_code`, `address`, `total_quantity`, `total_sub_total`, `grand_total`, `status`, `payment_type`, `payment_status`, `payment_url`, `user_id`, `created_at`, `updated_at`) VALUES
	...
	(20, 'FRT-VHWFD0LKEY', 'Ridho Aziztatiko', 'ridhoaziz18@gmail.com', '+6287887967328', 'Cilegon', '42155', 'Cilegon', 7, 112000, 122000, 'pending', 'qris', 'settlement', '3d67bebd-c5dc-471d-a518-2096dbc45a98', 3, '2025-07-29 11:46:52', '2025-07-29 11:46:53');
...
-- Dumping data for table faaroti_db.transaction_items: ~7 rows (approximately)
INSERT INTO `transaction_items` (`id`, `transaction_id`, `product_id`, `product_name`, `product_photo`, `quantity`, `price_at_purchase`, `sub_total_item`, `created_at`, `updated_at`) VALUES
	...
	(38, 20, 11, 'Bolu Maniss Lumer', 'products/01K02JX21ZA7FJPJ6GCMV05Q4C.jpg', 5, 20000, 100000, '2025-07-29 11:46:52', '2025-07-29 11:46:52'),
	(39, 20, 5, 'Roti Sosis Keju', 'products/01JZXN9D9DXC2KW3G73HJKHX3Z.jpg', 2, 6000, 12000, '2025-07-29 11:46:52', '2025-07-29 11:46:52');
